...
const CRM_Charts = (() => {
  ...
  function buildMonthlyCajaSeries_(now) {
    ...
    const currMap = buildMonthlyCajaPrevMap_(rows, idxFecha, idxCaja, start, end);
    const prevMap = buildMonthlyCajaPrevMap_(rows, idxFecha, idxCaja, prevStart, prevEnd);
    const objMap = buildMonthlyCajaPrevMap_(rows, idxFecha, idxObj, start, end);
    const redMap = buildMonthlyCajaPrevMap_(rows, idxFecha, idxRed, start, end);
    const orangeMap = buildMonthlyCajaPrevMap_(rows, idxFecha, idxOrange, start, end);
    const greenMap = buildMonthlyCajaPrevMap_(rows, idxFecha, idxGreen, start, end);
    const starMap = buildMonthlyCajaPrevMap_(rows, idxFecha, idxStar, start, end);
  ...
  function buildMonthlyCajaPrevMap_(rows, idxFecha, idxCaja, prevStart, prevEnd) {
    const map = {};
